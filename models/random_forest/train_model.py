...
def save_model_and_results(model, feature_importance, metrics, optimal_threshold, best_params=None):
    ...
    with open(RESULTS_PATH, 'a') as f:        
        ...
        f.write("- **Model file**: `models/random_forest/model.pkl`\n\n")
        
        f.write("### Visualization\n")
        f.write("- Feature Importance: `models/random_forest/feature_importance.png`\n")
        f.write("- ROC Curve: `models/random_forest/roc_curve.png`\n")
